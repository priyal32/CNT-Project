...
Make sure that your Peer.peerProcess name is the same as the one used in this program.
If your Peer.peerProcess is written in C or C++, you must modify the StartRemotePeers.java file
...
2. Copy *.java and compileJava files to your working directory where your Peer.peerProcess resides.
